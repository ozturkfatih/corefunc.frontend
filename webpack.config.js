...
module.exports = env => {
    ...
    return ({
        ...
        output: {
            path: path.resolve(__dirname, _.folder(paths.public.scripts)),
            filename: '[name].js',
            publicPath: '/scripts/'
        },
        module: {
        ...
        devServer: {
            contentBase: path.resolve(__dirname, _.folder(paths.public)),
            open: true,
            port: 4000,
            https: false,
            watchOptions: {
       ...
       optimization: {
        ...
        resolve: {
            extensions: [".ts", ".tsx", '.js', '.vue', '.vue.ts','json'],
            modules: [
                path.resolve(__dirname, _.folder(paths.public.styles)),
                'node_modules'
            ],
            alias: {
